            ...
            if (goalTitle.isEmpty ()) {
                ...
                switch (currency) {
                    ...
                    case "4":
                        ...
                        break;
                    case "5":
                        textView_goalCost.setText (String.valueOf ((String.valueOf (getString (R.string.costs) + " " + goalCostString) + " " + getString (R.string.money_Rupee) +
                                " | " + getString (R.string.alreadySaved) + " " + costString + " " + getString (R.string.money_Rupee) +
                                " | " + getString (R.string.costsRemaining) + " " + remCostString + " " + getString (R.string.money_Rupee))));
                        break;

                    case "6":
                        textView_goalCost.setText (String.valueOf ((String.valueOf (getString (R.string.costs) + " " + goalCostString) + " " + getString (R.string.money_BRL) +
                                " | " + getString (R.string.alreadySaved) + " " + costString + " " + getString (R.string.money_BRL) +
                                " | " + getString (R.string.costsRemaining) + " " + remCostString + " " + getString (R.string.money_BRL))));
                        break;

                    case "7":
                        textView_goalCost.setText (String.valueOf ((String.valueOf (getString (R.string.costs) + " " + goalCostString) + " " + getString (R.string.money_RUB) +
                                " | " + getString (R.string.alreadySaved) + " " + costString + " " + getString (R.string.money_RUB) +
                                " | " + getString (R.string.costsRemaining) + " " + remCostString + " " + getString (R.string.money_RUB))));
                        break;
                }
            }
                ...
                public void onClick(DialogInterface dialog, int item) {
                    ...
                    if (options[item].equals (getString (R.string.choose_gallery))) {
                        RxImagePicker.with (getActivity ()).requestImage (Sources.GALLERY)
                                .flatMap ((Function<Uri, ObservableSource<File>>) uri -> RxImageConverters.uriToFile (getActivity (), uri, new File (Environment.getExternalStorageDirectory () + "/Android/data/com.toquitsmoking.quitnow/" + helper_main.newFileName ()))).subscribe (new Consumer<File> () {
                            @Override
