...
public class FragmentHealth extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        setProgress (rootView, 175300, R.id.progressBar14, R.id.text_reached14);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId () == R.id.action_info) {
            ...
            final AlertDialog d=new AlertDialog.Builder (getActivity (), R.style.CustomAlertInfoDialogTheme)
    ...
    private void setProgress(View view, double hourTime, int progressBar_ID, int text) {
        ...
        try {
            ...
            String days=String.format (Locale.US, "%.0f", diffDays);
            String hours=String.format (Locale.US, "%.0f", diffHours);
            String minutes=String.format (Locale.US, "%.0f", diffMinutes);
