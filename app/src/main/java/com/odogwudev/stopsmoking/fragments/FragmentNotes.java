...
import com.odogwudev.stopsmoking.BuildConfig;
...
import com.odogwudev.stopsmoking.helper.DbAdapter_Notes;
...
public class FragmentNotes extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        ib_hideKeyboard.setOnClickListener (view -> {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M && isVisibleToUser && isResumed () && viewPager.getCurrentItem () == 3) {
            setNotesList ();
    ...
    private void setNotesList() {
        ...
        adapter.setFilterQueryProvider (constraint -> db.fetchDataByFilter (constraint.toString (), note_search));
        ...
        lv.setOnItemClickListener ((adapterview, view, position, id) -> {
            ...
            attachment.setOnClickListener (arg0 -> helper_main.openAtt (getActivity (), textInput, note_attachment));
            ...
            if (!file2.exists ()) {
                ...
                attImage.setOnClickListener (arg0 -> helper_main.openAtt (getActivity (), attImage, note_attachment));
            }
            ...
            AlertDialog.Builder dialog=new AlertDialog.Builder (getActivity (), R.style.
                    CustomAlertDialogTheme)
                    .setTitle (note_title)
                    .setView (dialogView)


                    .setPositiveButton (R.string.yes, (dialog1, whichButton) -> dialog1.cancel ())
                    .setNegativeButton (R.string.note_edit, (dialog12, whichButton) -> {
                        sharedPref.edit ()
        ...
        lv.setOnItemLongClickListener ((parent, view, position, id) -> {
            ...
            new AlertDialog.Builder (getActivity ())
                    .setPositiveButton (R.string.no, (dialog, whichButton) -> dialog.cancel ())
                    .setItems (options, (dialog, item) -> {
                        ...
                        if (options[item].equals (getString (R.string.note_share))) {
                            ...
                            if (attachment.exists ()) {
                                Uri bmpUri=FileProvider.getUriForFile (getContext (), BuildConfig.APPLICATION_ID + ".provider", attachment);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId ()) {
            ...
            case R.id.backup_backup:
                File directory=new File (Environment.getExternalStorageDirectory () + "/ToQuitSmoking/backup/");
                if (!directory.exists ()) {
                ...
                try {
                    ...
                    if (sd.canWrite ()) {
                        String currentDBPath="//data//" + "com.toquitsmoking.quitnow"
                                + "//databases//" + "notes_DB_v01.db";
                        String backupDBPath="//Android//" + "//data//" + "//toquitsmoking.backup//" + "notes_DB_v01.db";
