                            ...
                            RxImagePicker.with (Activity_EditNote.this).requestImage (Sources.GALLERY)
                                    .flatMap (new Function<Uri, ObservableSource<File>> () {
                                        ...
                                        public ObservableSource<File> apply(@NonNull Uri uri) throws Exception {
                                            return RxImageConverters.uriToFile (Activity_EditNote.this, uri, new File (Environment.getExternalStorageDirectory () + "/Android/data/com.toquitsmoking.quitnow/" + helper_main.newFileName ()));
                                        }
                                ...
                                if (options[item].equals (getString (R.string.paste_date))) {
                                    ...
                                    switch (dateFormat) {
                                        ...
                                        case "3":
                                            ...
                                            Date date3=new Date ();
                                            SimpleDateFormat format3=new SimpleDateFormat ("dd.MM.yyyy", Locale.getDefault ());
                                            String dateNow3=format3.format (date3);

                                            if (sharedPref.getString ("editTextFocus", "").equals ("text")) {
                                                textInput.getText ().insert (textInput.getSelectionStart (), dateNow3);
                                            } else {
                                                titleInput.getText ().insert (titleInput.getSelectionStart (), dateNow3);
                                            }
                                            break;
                                    }
                                }
